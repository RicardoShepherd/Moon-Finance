          ...
          child: AppBar(
            ...
            leading: Align(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('EDITPROFILE_PAGE_angleLeft_ICN_ON_TAP');
        ...
        body: Align(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 16.0, 0.0, 1.0),
                child: Text(
                  FFLocalizations.of(context).getText(
                    'rbpjf2yq' /* Ricardo Shepherd */,
                  ),
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EDITPROFILE_PAGE_Row_oy4o7ii4_ON_TAP');
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'mo07h9im' /* Notification Settings */,
                                              ),
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
