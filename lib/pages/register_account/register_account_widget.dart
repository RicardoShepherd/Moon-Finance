                                  ...
                                  children: [
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return TextFormField(
                                            ...
                                            onFieldSubmitted: (_) async {
                                              logFirebaseEvent(
                                                  'REGISTER_ACCOUNT_username_ON_TEXTFIELD_S');
                                              logFirebaseEvent(
                                                  'username_set_form_field');
                                              safeSetState(() {
                                                _model.usernameTextController
                                                    ?.text = 'username';
                                              });
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (_) async {
                                          logFirebaseEvent(
                                              'REGISTER_ACCOUNT_emailAddress_ON_TEXTFIE');
                                          logFirebaseEvent(
                                              'emailAddress_set_form_field');
                                          safeSetState(() {
                                            _model.emailAddressTextController
                                                ?.text = 'Email login';
                                          });
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (_) async {
                                          logFirebaseEvent(
                                              'REGISTER_ACCOUNT_password-Create_ON_TEXT');
                                          logFirebaseEvent(
                                              'password-Create_set_form_field');
                                          safeSetState(() {
                                            _model.passwordCreateTextController
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (_) async {
                                          logFirebaseEvent(
                                              'REGISTER_ACCOUNT_passwordConfirm_ON_TEXT');
                                          logFirebaseEvent(
                                              'passwordConfirm_set_form_field');
                                          safeSetState(() {
