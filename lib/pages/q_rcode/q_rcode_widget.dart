import '/components/restqrcode_widget.dart';
import '/components/shareqrcode_widget.dart';
                ...
                Expanded(
                  child: Align(
                    ...
                    child: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent('Q_RCODE_PAGE_angleLeft_ICN_ON_TAP');
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/photo_2024-12-26_15.25.20.jpeg',
                      width: 374.0,
                      height: 369.0,
                      fit: BoxFit.cover,
                    ),
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(10.0, 180.0, 0.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('Q_RCODE_PAGE__BTN_ON_TAP');
