                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (_) async {
                                        logFirebaseEvent(
                                            'LOGIN_emailAddress-login_ON_TEXTFIELD_SU');
                                        logFirebaseEvent(
                                            'emailAddress-login_set_form_field');
                                        safeSetState(() {
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (_) async {
                                        logFirebaseEvent(
                                            'LOGIN_password-login_ON_TEXTFIELD_SUBMIT');
                                        logFirebaseEvent(
                                            'password-login_set_form_field');
                                        safeSetState(() {
                                          _model.passwordLoginTextController
                                              ?.text = 'password';
                                        });
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'LOGIN_FORGET_PASSWORD__BTN_ON_TAP');
                                            logFirebaseEvent('Button_auth');
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'LOGIN_Container_ob0n5i46_ON_TAP');
                                            logFirebaseEvent(
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LOGIN_PAGE_PAGE_Text_9a39qx7d_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Text_navigate_to');
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOGIN_PAGE_PAGE_Icon_x89iah4s_ON_TAP');
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOGIN_PAGE_PAGE_Icon_cn7h97sc_ON_TAP');
                                              logFirebaseEvent('Icon_auth');
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                              final user = await authManager
