      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SUPPORT_cancel_rounded_ICN_ON_TAP');
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('SUPPORT_RESET_PASSWORD_BTN_ON_TAP');
                    logFirebaseEvent('Button_navigate_to');

                    context.pushNamed(ForgotPasswordWidget.routeName);
                  },
                  text: FFLocalizations.of(context).getText(
                    '9le367m8' /* Reset Password */,
                  ),
