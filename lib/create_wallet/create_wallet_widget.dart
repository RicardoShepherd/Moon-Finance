...
class _CreateWalletWidgetState extends State<CreateWalletWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CreateWallet'});
          ...
          child: AppBar(
            ...
            leading: Align(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CREATE_WALLET_PAGE_angleLeft_ICN_ON_TAP');
              ...
              children: [
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'nr2e0hvz' /* Create a new USD stable Coin a... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                ...
                Expanded(
                  child: Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(70.0, 0.0, 70.0, 30.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
