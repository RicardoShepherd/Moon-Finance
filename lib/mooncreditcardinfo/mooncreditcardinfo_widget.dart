...
class MooncreditcardinfoWidget extends StatefulWidget {
  const MooncreditcardinfoWidget({super.key});

  static String routeName = 'mooncreditcardinfo';
  static String routePath = '/mooncreditcardinfo';

  @override
  State<MooncreditcardinfoWidget> createState() =>
      _MooncreditcardinfoWidgetState();
}

class _MooncreditcardinfoWidgetState extends State<MooncreditcardinfoWidget> {
  late MooncreditcardinfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MooncreditcardinfoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'mooncreditcardinfo'});
            ...
            children: [
              Padding(
                ...
                child: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent(
                        'MOONCREDITCARDINFO_chevron_left_ICN_ON_T');
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'jnt7adgu' /* Confirm or update the followin... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        validator: _model
                                            ...
                                            .asValidator(context),
                                        inputFormatters: [_model.lastnameMask],
                                      ),
                                      TextFormField(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onDoubleTap: () async {
                            logFirebaseEvent(
                                'MOONCREDITCARDINFO_CONTINUE_BTN_ON_DOUBL');
                            logFirebaseEvent('Button_navigate_to');

                            context.pushNamed(
                                MooncreditcardaddressWidget.routeName);
                          },
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MOONCREDITCARDINFO_CONTINUE_BTN_ON_TAP');
