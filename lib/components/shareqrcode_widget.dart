...
import 'shareqrcode_model.dart';
export 'shareqrcode_model.dart';

class ShareqrcodeWidget extends StatefulWidget {
  const ShareqrcodeWidget({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 9.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
