                      ...
                      children: [
                          ...
                          children: [
                            Card(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOME_PAGE_CircleImage_brificop_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent('HOME_PAGE_EARN_50_BTN_ON_TAP');
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'HOME_PAGE_ADD_MONEY_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_bottom_sheet');
                                      ...
                                      FFButtonWidget(
                                        ...
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'mnmfdkvq' /* High Yield Saving A\C */,
                                        ),
                                        icon: Icon(
                              ...
                              items: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_Container_bby90d64_ON_TAP');
                      ...
                      children: [
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Column_sue5yvyg_ON_TAP');
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Column_952ucryb_ON_TAP');
                              logFirebaseEvent('Column_navigate_to');
                      ...
                      children: [
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Column_k653ckwp_ON_TAP');
                              logFirebaseEvent('Column_navigate_to');
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Column_pf09btvy_ON_TAP');
                              logFirebaseEvent('Column_navigate_to');
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Column_qzl3csn0_ON_TAP');
                              logFirebaseEvent('Column_navigate_to');

                              context.pushNamed(BettingMarketWidget.routeName);
                            },
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_Button_ssj5mocq_ON_TAP');
                            ...
                            Align(
                              ...
                              child: FlutterFlowChoiceChips(
                                ...
                                selectedChipStyle: ChipStyle(
                                  backgroundColor: Color(0x4C69686E),
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Plus Jakarta Sans',
